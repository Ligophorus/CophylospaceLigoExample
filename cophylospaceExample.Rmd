...
```{r tanglegram2, fig.cap = "Fig. 2. Association between the phylogeny of six grey mullet species and the shape of the ventral anchors of 14 species of *Ligophorus*. See Fig. for species abbrevations.", message = FALSE, fig.height = 4.5, fig.width = 9}
...
```{r tanglegram3, fig.cap = "Fig. 3. Association between morphometric characters of six grey mullet species and the phylogeny of 14 species of *Ligophorus* See Fig. for species abbrevations.", message = FALSE, fig.height = 4.5, fig.width = 9}
...
``` {r 3dplot, fig.cap = "Fig. 4. Position in cophylospace of the host-parasite system studied (six grey mullet species associtated with 14 species of *Ligophorus*). The plot is interactive. Its orientation can be changed by left-clicking and dragging. Use also the mouse wheel to zoom in and out.", fig.height = 7}
